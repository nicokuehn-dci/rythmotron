"""
Sequencer section for the Analog Rytm Emulator.
Contains the step sequencer interface with trigger buttons and controls.
"""

from PySide6.QtWidgets import QWidget, QFrame, QGridLayout, QVBoxLayout, QLabel, QComboBox
